...
import io.imking.biz.reward.domain.RwCommentExample.Criteria;
import io.imking.biz.reward.domain.RwCommentExample.Criterion;
import io.imking.biz.reward.domain.RwCommentExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class RwCommentSqlProvider {

    public String countByExample(RwCommentExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("rw_comment");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RwCommentExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("rw_comment");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(RwComment record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("rw_comment");
        ...
        if (record.getRwAnswerId() != null) {
            sql.VALUES("rw_answer_id", "#{rwAnswerId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(RwCommentExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RwComment record = (RwComment) parameter.get("record");
        RwCommentExample example = (RwCommentExample) parameter.get("example");
        ...
        if (record.getRwAnswerId() != null) {
            sql.SET("rw_answer_id = #{record.rwAnswerId,jdbcType=INTEGER}");
        }
        ...
        if (record.getLikeNum() != null) {
            sql.SET("like_num = #{record.likeNum,jdbcType=INTEGER}");
        }
