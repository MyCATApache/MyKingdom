...
import io.imking.biz.reward.domain.RwAnswerExample.Criteria;
import io.imking.biz.reward.domain.RwAnswerExample.Criterion;
import io.imking.biz.reward.domain.RwAnswerExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class RwAnswerSqlProvider {

    public String countByExample(RwAnswerExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("rw_answer");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RwAnswerExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("rw_answer");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(RwAnswer record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("rw_answer");
    ...
    public String selectByExample(RwAnswerExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RwAnswer record = (RwAnswer) parameter.get("record");
        RwAnswerExample example = (RwAnswerExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("rw_answer");
    ...
    public String updateByPrimaryKeySelective(RwAnswer record) {
        SQL sql = new SQL();
        sql.UPDATE("rw_answer");
    ...
    protected void applyWhere(SQL sql, RwAnswerExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
